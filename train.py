...
def parse_args():
    ...
    parser.add_argument('--train_h5_path', type=str, default='./data/train_aug.h5', help='train_data')
    parser.add_argument('--test_h5_path', type=str, default='./data/test_aug.h5', help='test_data')
